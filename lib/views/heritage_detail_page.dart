...
// ============================================================
  ...
  Future<void> _addToJourney() async {
    if (_addingToJourney) return;

    setState(() {
      _addingToJourney = true;
    });

    try {
      final added = await _storage.addToDiary(attraction);
      ...
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(
          SnackBar(
            backgroundColor: added ? green : Colors.orange.shade700,
            behavior: SnackBarBehavior.floating,
            content: Text(
              added
                  ? '${attraction.name} added to your Heritage Journey.'
                  : '${attraction.name} is already in your Heritage Journey for today.',
            ),
          ),
        );
    } catch (error) {
      ...
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(
          SnackBar(
            ...
            behavior: SnackBarBehavior.floating,
            content: Text(
              'Unable to add this attraction to your Heritage Journey: $error',
            ),
          ),
        );
    } finally {
...
// ============================================================
// ADD TO HERITAGE JOURNEY BUTTON
// ============================================================

  Widget _buildAddToJourneyButton() {
    return SizedBox(
      width: double.infinity,
      height: 40,
      child: ElevatedButton.icon(
        onPressed: _addingToJourney ? null : _addToJourney,
        style: ElevatedButton.styleFrom(
          backgroundColor: green,
          foregroundColor: Colors.white,
          disabledBackgroundColor: green.withOpacity(0.55),
